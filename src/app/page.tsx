...
export default async function Home(){
 ...
 const cats=(categories??[]) as Category[]; const items=(products??[]) as Product[]; const hero=((banners??[]) as Banner[])[0]; const content=(blocks??[]) as Block[];
 const categoryTiles=[
