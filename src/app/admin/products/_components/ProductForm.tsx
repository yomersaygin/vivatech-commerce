...
export default function ProductForm({ productId, initialMessage = '' }: { productId?: string; initialMessage?: string }) {
  ...
  return <>
    ...
    <form className="product-form" onSubmit={submit}>
      ...
      <section className="form-card"><div className="section-row"><div><h2>SEO</h2><p className="muted">Boş bırakırsanız kaydederken ürün bilgilerinden otomatik oluşturulur.</p></div><button type="button" className="button secondary compact" onClick={generateSeoDraft}>SEO Taslağını Yenile</button></div>
